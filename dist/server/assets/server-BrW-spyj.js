...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-Cr4-YNsD.js");
...
const manifest = {
  "d14c03a65f7c855fb8a2bd675c99851c1445338e64703529f9f13543c700e7c9": {
    functionName: "generateImage_createServerFn_handler",
    importer: () => import("./image-gen.functions--2m1n2vL.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-cWw2dBF4.js").then((n2) => n2.r),
    import("./start-nW8oYAts.js"),
